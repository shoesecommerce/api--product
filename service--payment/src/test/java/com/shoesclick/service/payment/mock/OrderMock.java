...
public class OrderMock {
    ...
    public static PaymentDomain getPaymentDomain_TICKET_PAYMENT() {
        return new PaymentDomain().setOrder(new Order().setId(1L)).setPaymentParams(Map.of("codeBar", "3324234234234234324324324234")).setPaymentType("TICKET_PAYMENT");
    }
}
